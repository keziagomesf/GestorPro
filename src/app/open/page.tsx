...
export default function OpenTicket(){
    ...
    return(
        <div className="w-fuull max-w-2xl mx-auto px-2">
            <h1 className="font-bold text-3xl text-center mt-24">Abrir chamado</h1>

            <main className="flex flex-col mt-4 mb-2">
                {customer ? (
                    <div className="bg-slate-100 py-6 px-4 rounded border-1 flex items-center justify-between">
                    ...
                    <form className="bg-slate-100 py-6 px-2 rounded border-1"
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <button type="submit" className="bg-blue-500 flex flex-row gap-3 px-2 h-11 items-center justify-center rounded text-white">
                            Procurar clientes
